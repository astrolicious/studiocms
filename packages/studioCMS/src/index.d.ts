...
export let externalNavigation: Map<string, { text: string, slug: string }>;
export let customRendererPlugin: Set<string>;
 ...
 *
 */
export function studioCMS(options?: StudioCMSOptions): AstroIntegration;
