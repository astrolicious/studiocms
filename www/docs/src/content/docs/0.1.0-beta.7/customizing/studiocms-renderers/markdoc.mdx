...
sidebar:
  badge:
    text: Advanced
    variant: tip
slug: 0.1.0-beta.7/customizing/studiocms-renderers/markdoc
---
...
<ReadMore>For more information on how to configure the MarkDoc renderer, see the [MarkDoc Configuration](/0.1.0-beta.7/config-reference/markdoc-config/) documentation.</ReadMore>
