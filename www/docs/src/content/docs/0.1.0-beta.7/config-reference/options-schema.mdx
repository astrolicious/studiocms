...
sidebar:
  order: 1
slug: 0.1.0-beta.7/config-reference/options-schema
---
...
<ReadMore>[See `rendererConfig` for full options](/0.1.0-beta.7/config-reference/renderer-config)</ReadMore>
...
<ReadMore>[See `imageService` for full options](/0.1.0-beta.7/config-reference/image-service)</ReadMore>
...
<ReadMore>[See `defaultFrontEndConfig` for full options](/0.1.0-beta.7/config-reference/default-frontend-config)</ReadMore>
...
<ReadMore>[See `dashboardConfig` for full options](/0.1.0-beta.7/config-reference/dashboard)</ReadMore>
...
<ReadMore>[See `includedIntegrations` for full options](/0.1.0-beta.7/config-reference/included-integrations)</ReadMore>
...
<ReadMore>[See `overrides` for full options](/0.1.0-beta.7/config-reference/overrides)</ReadMore>
