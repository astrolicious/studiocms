...
sidebar:
  order: 2
slug: 0.1.0-beta.7/config-reference/renderer-config
---
...
<ReadMore>[See `markedConfig` for full options](/0.1.0-beta.7/config-reference/marked-config)</ReadMore>
...
<ReadMore>[See `markdocConfig` for full options](/0.1.0-beta.7/config-reference/markdoc-config)</ReadMore>
...
<ReadMore>[See `mdxConfig` for full options](/0.1.0-beta.7/config-reference/mdx-config)</ReadMore>
