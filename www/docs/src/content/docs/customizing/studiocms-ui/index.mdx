...
:::caution
If you want to avoid bundling issues, please set the `experimental.directRenderScript` flag in your `astro.config.mjs` file to true. 
This flag is accessible from Astro v4.5.0 onwards. If you are using v5.0.0(-beta) of Astro, you do not need to set this flag as it has
become stable.
:::
