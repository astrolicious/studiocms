...
StudioCMS allows you to define custom renderers for your content. This allows you to define custom rendering logic for your content.
...
const customRenderer: CustomRenderer = {
  name: 'CustomRenderer',
  renderer: async (content: string): Promise<string> => {
