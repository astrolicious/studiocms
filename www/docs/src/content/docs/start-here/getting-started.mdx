...
If this is your first time setting up StudioCMS you will also see a message indicating that you need to setup your StudioCMS install at `http://localhost:4321/start`
