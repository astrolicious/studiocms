...
Astro Studio is currently in closed beta. You'll need an invite to create an account. For now if you do not have an account, you can use the [libSQL option](#using-libsql) to get started using another libSQL provider.
</Aside>
