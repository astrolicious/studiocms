...
slug: 0.1.0-beta.5/how-it-works
---
...
* **studiocms**: The primary integration that hooks into your Astro project and provides the ability to interact with Astro Studio (through the `@astrojs/db` integration).
