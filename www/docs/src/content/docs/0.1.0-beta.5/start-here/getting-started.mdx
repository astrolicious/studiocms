...
slug: 0.1.0-beta.5/start-here/getting-started
---
...
Check out how to set environment variables in Astro StudioCMS by heading to [Environment Variables](/0.1.0-beta.5/start-here/environment-variables).

To learn more about the API and how to use Astro StudioCMS, check out the [Astro StudioCMS Reference](/0.1.0-beta.5/typedoc/studiocms-core/index/functions/studiocmscoreintegration/).
