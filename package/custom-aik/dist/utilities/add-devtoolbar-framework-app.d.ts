...
type AddDevToolbarFrameworkAppParams = {
    ...
    src: string;
    style?: string;
} & Pick<HookParameters<"astro:config:setup">, "config" | "addDevToolbarApp" | "updateConfig" | "injectScript">;
/**
 ...
 */
declare const addDevToolbarFrameworkApp: ({ id, name, icon, framework, src, style, config, addDevToolbarApp, updateConfig, injectScript, }: AddDevToolbarFrameworkAppParams) => void;

export { type AddDevToolbarFrameworkAppParams, addDevToolbarFrameworkApp };
